...
async function getMeaning(){
    ...
    if(input.length > 0){
        try{
            ...
            // storing the information retrive in data, reason for using [0],bcus will want to display the first meaning of the word
            ...
            document.getElementById("example").innerHTML = data.meanings[0].definitions[0].example
